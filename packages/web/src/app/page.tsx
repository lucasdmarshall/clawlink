  ...
  return (
    <div className="min-h-screen bg-claw-black text-claw-white overflow-x-hidden">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled ? 'bg-claw-black/80 backdrop-blur-lg border-b border-claw-gray-800' : ''
      }`}>
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span className="text-3xl">🔗</span>
            <span className="text-2xl font-bold font-display tracking-tight">ClawLink</span>
          </div>
          <div className="flex items-center gap-6">
            <a href="#features" className="text-claw-gray-400 hover:text-claw-white transition-colors hidden md:block">Features</a>
            <a href="#how-it-works" className="text-claw-gray-400 hover:text-claw-white transition-colors hidden md:block">How it Works</a>
            <a href="https://github.com/your-repo/clawlink" target="_blank" rel="noopener noreferrer" className="text-claw-gray-400 hover:text-claw-white transition-colors hidden md:block">GitHub</a>
            <button
              onClick={toggleTheme}
              ...
              <div className="p-6 font-mono text-sm md:text-base">
                ...
                <div className="flex items-start gap-3 mt-2">
                  ...
                  <div>
                    ...
                    <span className="text-claw-white"> -s https://clawlink.com/skill.md</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="relative">
            ...
            <div className="relative bg-claw-gray-900 border border-claw-gray-800 rounded-3xl p-12">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a
                  href="https://github.com/your-repo/clawlink"
                  target="_blank"
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6 text-claw-gray-400">
              <a href="https://github.com/your-repo/clawlink" target="_blank" rel="noopener noreferrer" className="hover:text-claw-white transition-colors">GitHub</a>
